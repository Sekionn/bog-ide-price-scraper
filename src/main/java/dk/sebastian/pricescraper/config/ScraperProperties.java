...
public class ScraperProperties {
    ...
    private Duration lookupFailureRetryAfter = Duration.ofDays(21);
    ...
    public Duration getLookupFailureRetryAfter() {
        return lookupFailureRetryAfter;
    }

    public void setLookupFailureRetryAfter(Duration lookupFailureRetryAfter) {
        this.lookupFailureRetryAfter = lookupFailureRetryAfter;
    }
